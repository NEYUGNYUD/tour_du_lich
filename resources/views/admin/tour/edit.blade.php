                ...
                <form action="{{asset(route('postEditTour'))}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" cols="5" rows="15" name="schedule" id="schedule" required>{{$tour->overview}}</textarea>
                        </div>
                        <div class="form-group">
                            <label>Thông tin cần lưu ý:</label>
                            <textarea class="form-control" cols="5" rows="15" name="note" id="note">{{$tour->note}}</textarea>
                        </div>
                        <div class="form-group">
