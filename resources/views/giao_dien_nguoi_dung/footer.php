    ...
    <div class="container">
        ...
        <div class="row foot_row2">
            ...
            <div class="col-sm-4">
                ...
                <ul class="list-inline">
                    <li><a href=""><img src="images/android.png" width="150" alt="Phiên bản Adroid"/></a></li>
                    <li><a href=""><img src="images/IOS.png" width="150" alt="Phiên bản IOS"/></a></li>
                </ul>
            </div>
            <div class="col-sm-4">
                ...
                <ul class="list-unstyled col-2">
                    <li>
                        <img width="16" height="16" alt="Đang truy cập" src="images/users.png">
                        Đang truy cập : <strong>24</strong>
                    </li>
                    <li>
                        <img width="16" height="16" alt="Hôm nay" src="images/today.png">
                        Hôm nay : <strong>33</strong>
                    </li>
                    <li>
                        <img width="16" height="16" alt="Tháng hiện tại" src="images/month.png">
                        Tháng hiện tại : <strong>2089</strong>
                    </li>
                    <li>
                        <img width="16" height="16" alt="Tổng lượt truy cập" src="images/hits.png">
...
<script id="scriptToReload" src="js/hotel365.js"></script>
<script>
    (function ($) {
